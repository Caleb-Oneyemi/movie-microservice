...
// creates a service record in the registry.
...
// removes a service record from the registry.
func (r *Registry) Deregister(ctx context.Context, instanceID string, _ string) error {
	return r.client.Agent().ServiceDeregister(instanceID)
}

// push mechanism for reporting healthy state to the registry.
...
func (r *Registry) GetServiceAddresses(ctx context.Context, serviceName string) ([]string, error) {
